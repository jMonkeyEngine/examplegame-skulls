 ...
 * @author nidebruyn
 */
public class EnemyXControl extends EnemyControl {
    ...
    public EnemyXControl(Game game, Tile tile) {
        super(game, tile);
    }
        ...
        if (alive && move) {
            ...
            if (ritualActive) {
                ...
                if (ritualTimer.finished()) {
                    ...
                    idle = false;
                    ritualActive = false;
                    cursed = true; //Enemy needs to wait for 2 seconds before he can perform a ritual again
                    cursedTimer.reset();
                }
            }
